...
namespace DeviceShop
{
    ...
    public partial class DeviceShopEntities2 : DbContext
    {
        public DeviceShopEntities2()
            : base("name=DeviceShopEntities2")
        {
        }
        ...
        public virtual DbSet<SpecificationComponents> SpecificationComponents { get; set; }
        public virtual DbSet<SpecificationOperations> SpecificationOperations { get; set; }
